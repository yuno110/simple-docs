...
| [0006](0006-auth-inside-member-service.md) | auth를 member-service 내 패키지로 | **superseded → [0012](0012-auth-as-separate-service.md)** |
...
| [0012](0012-auth-as-separate-service.md) | auth를 별도 서비스로 분리 | accepted |
